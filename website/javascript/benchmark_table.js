...
document.addEventListener('DOMContentLoaded', function () {
    fetch('website/data/webvoyager_table.json')
  .then(response => response.json())
  .then(benchmark_tabledata => {
    new Tabulator("#benchmark-table", {
      ...
      columns: [
        { title: "Model", field: "model", minWidth: 160 },
        { title: "Open-Weight", field: "openweight", hozAlign: "center", width: 160 },
        { title: "Open-Data", field: "opendata", hozAlign: "center", width: 160 },
        { title: "Average", field: "avg", hozAlign: "center", formatter: colorFormatter, minWidth: 120 },
        { title: "Allrecipes", field: "allrecipes", hozAlign: "center", formatter: colorFormatter },
        { title: "Amazon", field: "amazon", hozAlign: "center", formatter: colorFormatter },
        { title: "Apple", field: "apple", hozAlign: "center", formatter: colorFormatter },
        { title: "ArXiv", field: "arxiv", hozAlign: "center", formatter: colorFormatter },
        { title: "GitHub", field: "github", hozAlign: "center", formatter: colorFormatter },
        { title: "ESPN", field: "espn", hozAlign: "center", formatter: colorFormatter },
        { title: "Coursera", field: "coursera", hozAlign: "center", formatter: colorFormatter },
        { title: "Cambridge", field: "cambridge", hozAlign: "center", formatter: colorFormatter },
        { title: "BBC", field: "bbc", hozAlign: "center", formatter: colorFormatter },
        { title: "Map", field: "map", hozAlign: "center", formatter: colorFormatter },
        { title: "Search", field: "search", hozAlign: "center", formatter: colorFormatter },
        { title: "HuggingFace", field: "huggingface", hozAlign: "center", formatter: colorFormatter },
        { title: "WolframAlpha", field: "wolframalpha", hozAlign: "center", formatter: colorFormatter }
      ]
    });
  });
